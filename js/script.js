...
$(document).ready(function () {
    ...
    var inputButton = document.getElementById("searchbutton");
    ...
    Layerpolice = new ol.layer.Vector({
        title: 'Police',
        visible: false,
        ...
        source: new ol.source.Vector({
            ...
            url: "https://safapaslatete.carto.com/api/v2/sql?q=select*from%20police&format=" + format + "&api_key=" + key,
            format: new ol.format.GeoJSON()
        })
    }),

        map.addLayer(Layerpolice);
    ...
    $("#Police").click(function () {
        Layerpolice.setVisible(!Layerpolice.getVisible());
    });
    ...
    function geocodage() {
        ...
        $.getJSON(urlAdresse, function (json) {
            ...
            if (json != "") {
                ...
                console.log(latAdresse)
                console.log(lngAdresse)
    ...
    var selectInteraction = new ol.interaction.Select({
        ...
        layers: [Layeracc, Layeraccvelo, Layeraccpietons, Layeraccroutesecondaire, Layeraccrouteprincipale, Layeraccautoroute]
    });
    ...
    selectInteraction.on('select', function (e) {
        ...
        var AccID = e.selected[0].get("id_acciden");
        console.log(e.selected[0].get("id_acciden"));

        /**  $.get("https://safapasletete.carto.com/api/v2/sql?format=GeoJSON&q=select%20the_geom,target_cartodb_id,closest_dist%20from%20accident_3%20where%20source_cartodb_id%20=%20" + AccID)
         .done( data => {
        ...
        var sqlurl = "https://safapasletete.carto.com/api/v2/sql?format=GeoJSON&q=select%20the_geom,target_cartodb_id,closest_dist%20from%20accident_3%20where%20source_cartodb_id%20=%20" + AccID
